...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig('B:\\my_model\\re_set2_batch_8_res50.jpg')
        plt.show()
...
if __name__ == '__main__':
    #for i in range(50):
        if os.path.exists('B:\\my_model\\re_set2_batch_8_res50.h5'):
            model=load_model('B:\\my_model\\re_set2_batch_8_res50.h5')
        else:
            model=check_print()
        ...
        checkpoint = ModelCheckpoint(filepath='B:\\my_model\\re_set2_batch_8_res50.h5', monitor='val_acc', verbose=1, save_best_only=True,mode='max')
        #save best
...
for i in model.layers:
    ...
    print(p)
    p=p+1
plot_model(model, to_file='B:\\res_50.png', show_shapes=True)
